...
function transport({ status = 200, headers = {}, authorized = true, chunks = [Buffer.from('test')], complete = true, abort = false, abortOnDestroy = false, stall = false, error } = {}) {
...
it.each([
    ...
    [{ status: 308, abortOnDestroy: true }, 'entrypoint-http-308'],
