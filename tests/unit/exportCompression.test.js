...
describe('HF1 standalone Web compression rollout', () => {
    ...
    it('editor settings migrate without rewriting the archive contract or codec policy', () => {
        ...
        expect(web.workspace.exportSettings).toEqual({ format: 'avif', ratio: 2 });
...
describe('C1 settings and persistence contract', () => {
    ...
    it.each([
        ...
        expect(runtime.workspace.exportSettings).toEqual(settings.format === 'avif' ? { format: 'avif', ratio: settings.ratio } : settings);
