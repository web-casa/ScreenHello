...
2026-09-17 项目审阅发现的四项异步生命周期问题已在本地修复：保存快照基线、原生退出确认、预设请求失效与选择器 token 回收。另修复打开项目缓存和保存预设时的同类快照问题；验证及平台边界见[项目审阅记录](./project-review-2026-09-17.md)。这些改动尚未进入新的签名安装包。

2026-09-17 本地追加[桌面 review 修复](./desktop-review-fixes-2026-09-17.md)：截图窗口恢复、文件名处理和权限/跨端契约测试；本轮改动尚未生成新的签名安装包。
