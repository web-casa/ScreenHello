/* 应用壳预缓存预算。原为 3 MiB；接入 Radix Themes（右栏控件）后实测壳体积到 3.08 MiB，
   其中 Radix 的样式表是固定成本（794 KB 原始）。这里放宽到 3.5 MiB，并保留每文件 1 MiB 的限制。 */
export const PWA_APP_SHELL_MAX_BYTES = 3.5 * 1024 * 1024;
