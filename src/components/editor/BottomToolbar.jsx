...
export default observer(function BottomToolbar() {
    ...
    return (
        <>
            ...
            <Divider orientation="vertical" className="shoteasy-toolbar-divider" />
            <Tooltip placement="top" arrow={false} title={t("移动 / 拖动")}>
                <Button
                    type="text"
                    shape="circle"
                    aria-label={t("移动 / 拖动")}
            ...
            <Tooltip placement="top" arrow={false} title={t("收起工具栏")}>
                <Button
                    type="text"
                    shape="circle"
                    aria-label={t("收起工具栏")}
            ...
            <Tooltip placement="top" arrow={false} title={t("展开标注工具栏")}>
                <Button
                    type="text"
                    shape="circle"
                    aria-label={t("展开标注工具栏")}
            ...
            <Button
                ...
                aria-label={t("打开标注工具{0}", { 0: stores.editor.useTool ? t('，当前{0}', { 0: t(toolLabels[stores.editor.useTool] || stores.editor.useTool) }) : '' })}
            ...
            {mobileOpen && (
                ...
                >
                    <div className="shoteasy-mobile-annotation-sheet">
                        <section aria-labelledby={primaryToolsId}>
                            <h3 id={primaryToolsId}>{t("形状与线条")}</h3>
                        ...
                        >
                            <summary>{t("更多标注工具")}</summary>
                            <div className="shoteasy-mobile-tool-grid">
                                {secondaryTools.map((item) => renderTool(item, true))}
                            </div>
                        </details>
                        <section aria-labelledby={toolStyleId}>
                            <h3 id={toolStyleId}>{t("样式与画布")}</h3>
                        ...
                        <p className="shoteasy-mobile-annotation-hint">{t("选择工具后会回到画布；再次点击当前工具可退出标注。")}</p>
                    </div>
                </Drawer>
            )}
        </>
