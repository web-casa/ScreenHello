...
// 公开文档站由 Fumadocs 生成，挂载在 /docs/{locale}/{topic}/。
export const publicGuidePath = (locale, base = '/') => `${base}docs/${Object.hasOwn(localePaths, locale) ? localePaths[locale] : 'en'}/guide/`;
