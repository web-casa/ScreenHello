...
import { validateExportSettings, normalizeEditorExportSettings } from '@utils/exportSettings';
...
const freezeStyle = style => {
    ...
    return Object.freeze({
        ...
        exportSettings: Object.freeze(normalizeEditorExportSettings(validateExportSettings(style.exportSettings))),
